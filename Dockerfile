...
RUN apt-get update && \
  ...
  curl -L -o /opt/spark/spark-3.3.1-bin-without-hadoop.tgz https://archive.apache.org/dist/spark/spark-3.3.1/spark-3.3.1-bin-without-hadoop.tgz && \
  ...
  tar -xzf /opt/spark/spark-3.3.1-bin-without-hadoop.tgz -C /opt/spark && \
  ...
  mkdir /opt/cdap/LICENSES/spark-3.3.1-bin-without-hadoop && cp /opt/spark/spark-3.3.1-bin-without-hadoop/LICENSE /opt/cdap/LICENSES/spark-3.3.1-bin-without-hadoop && cp /opt/spark/spark-3.3.1-bin-without-hadoop/NOTICE /opt/cdap/LICENSES/spark-3.3.1-bin-without-hadoop && \
...
ENV SPARK_HOME=/opt/spark/spark-3.3.1-bin-without-hadoop
